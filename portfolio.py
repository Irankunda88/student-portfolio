...
if page == "Home":  
    ...
    if authenticate():  
        ...
        if uploaded_image:  
            ...
            st.image("octave.jpg", width=150, caption="Default")  
    else:  
        st.image("octave.jpg", width=150, caption="Profile Pic (Owner Only)")  
    ...
    # Download resume  
    with open("octaveresume.pdf", "rb") as file:  
        resume_bytes = file.read()  
    st.download_button(label="📄 Download Resume",  
                       data=resume_bytes, file_name="octaveresume.pdf", mime="application/pdf")  
